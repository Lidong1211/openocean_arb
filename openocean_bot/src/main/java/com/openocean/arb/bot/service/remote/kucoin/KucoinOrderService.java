package com.openocean.arb.bot.service.remote.kucoin;
...
public class KucoinOrderService extends BaseOrderService implements RemoteOrderService {
    ...
    public void init() throws IOException {
        if (proxyConfig.isEnabled()) {
            HttpClientFactory.setProxy(new Proxy(Proxy.Type.SOCKS, new InetSocketAddress(proxyConfig.getHost(), proxyConfig.getPort())));
        }
